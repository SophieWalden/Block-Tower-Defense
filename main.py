...
class Tower():
    ...
    def __init__(self, x, y, rank):
        ...
        if rank == 1:
            ...
            self.descriptions =[[["Firen Ma Lazar",1500],["Thick Lazer",2500],["Double Lazer?",5000],["Unbeatable", 36000]],
                                [["Bigger Range", 800],["Biggest Range", 1500],["Mini-Death", 4000],["Unleash Havoc", 26000]]]
